...
<?php
    ...
    $wdw_vat = ( DISPLAY_TAX_INFO == 'true' ) ? ( DISPLAY_PRICE_WITH_TAX == 'true' ) ? '<br /><div class="wdw_vat_text">'. sprintf(TEXT_INCL_VAT, tep_get_tax_rate($product_info['products_tax_class_id']).'%') . '</div>' : '<br /><div class="wdw_vat_text">' . TEXT_EXCL_VAT . '</div>' : '';
      ...
      $products_price = '<span itemprop="price" content="' . $currencies->display_raw($product_info['products_price'], tep_get_tax_rate($product_info['products_tax_class_id'])) . '">' . $currencies->display_price($product_info['products_price'], tep_get_tax_rate($product_info['products_tax_class_id'])) . $wdw_vat . $wdw_shipping . '</span>';
    }
...
<?php echo $oscTemplate->getContent('wdw_product_info_box'); ?>
...
?>
	...
	<div class="row">
    <?php echo $oscTemplate->getContent('wdw_product_info'); ?>
  </div>
