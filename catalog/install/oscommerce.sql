...
insert into configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('238', 'Installed Modules', 'MODULE_BOXES_INSTALLED', 'bm_categories.php;bm_whats_new.php;bm_specials.php;bm_manufacturers.php;bm_product_social_bookmarks.php;bm_manufacturer_info.php;bm_card_acceptance.php;bm_order_history.php;bm_best_sellers.php', 'List of box module filenames separated by a semi-colon. This is automatically updated. No need to edit.', '6', '0', '2017-02-10 17:13:39', '2017-01-24 11:09:54', NULL, NULL);
...
insert into configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('342', 'Security Check Extended Last Run', 'MODULE_SECURITY_CHECK_EXTENDED_LAST_RUN_DATETIME', '1486743065', 'The date and time the last extended security check was performed.', '6', NULL, NULL, '2017-01-24 11:33:09', NULL, NULL);
...
</ul>', 'www.matrox.com/mga/products/mill_g400/home.htm', '225', '', '', '');
