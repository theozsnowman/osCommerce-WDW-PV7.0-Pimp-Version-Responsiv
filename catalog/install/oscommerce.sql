...
insert into configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('238', 'Installed Modules', 'MODULE_BOXES_INSTALLED', 'bm_categories.php;bm_whats_new.php;bm_specials.php;bm_manufacturers.php;bm_product_social_bookmarks.php;bm_best_sellers.php;bm_manufacturer_info.php;bm_card_acceptance.php;bm_order_history.php', 'List of box module filenames separated by a semi-colon. This is automatically updated. No need to edit.', '6', '0', '2017-02-10 17:39:57', '2017-01-24 11:09:54', NULL, NULL);
...
</ul>', 'www.matrox.com/mga/products/mill_g400/home.htm', '226', '', '', '');
...
Other: Interactive Menus, Chapter Selection, Subtitles (more languages).', 'www.bladerunner.com', '72', '', '', '');
...
insert into testimonials_description (testimonials_id, languages_id, testimonials_text) values ('3', '1', 'Thanks for the great response for my orders, the delivery is always in time. Kids just love it, thanks again.');
insert into testimonials_description (testimonials_id, languages_id, testimonials_text) values ('5', '1', 'Best purchase ever. These guys know how to provide a good service. Thank you so much.');
