...
?>
                ...
                <td class="dataTableContent"><?php echo '<a href="' . tep_href_link('products_multi.php', tep_get_path($categories['categories_id'])) . '">' . tep_image('images/icons/folder.gif', ICON_FOLDER) . '</a> <b>' . $categories['categories_name'] . '</b>'; ?></td>
...
?>
			  ...
			  <?php  if ($cPath) echo tep_draw_button(IMAGE_BACK, 'triangle-1-w', tep_href_link('products_multi.php',  $cPath_back . 'cID=' . $current_category_id)); ?>					
                  ...
                  <tr>
                    <td class="smallText"><?php //echo TEXT_CATEGORIES . ' ' . $categories_count . '<br>' . TEXT_PRODUCTS . ' ' . $cInfo->products_count . tep_get_parent_cat($current_category_id); ?></td>
                  ...
                  <tr>
                    <td align="right" class="smallText" colspan="3"><?php echo tep_draw_button(IMAGE_UPDATE, 'disk', null, 'primary'); ?></td>
                  </tr>
                  <tr>
