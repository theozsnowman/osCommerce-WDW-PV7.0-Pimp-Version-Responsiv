...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr class="headerBar">
    <td class="headerBarContent">&nbsp;&nbsp;<?php echo (tep_session_is_registered('admin') ? '<a id="admin" href="' . tep_href_link('index.php') . '" class="">' . HEADER_TITLE_ADMINISTRATION . '</a> <a target="_blank" id="shop" href="' . tep_catalog_href_link() . '" class="">' . HEADER_TITLE_ONLINE_CATALOG . '</a> <a id="show">' . BUTTON_SITEMAP_XML . '</a>' : ''); ?></td>
