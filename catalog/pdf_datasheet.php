<?php
/*
  $Id: pdf_datasheet.php 20111014 Kymation $
  $Loc: catalog/
...
// add the products model to the breadcrumb trail
  ...
  // Set the default filename in case the module is not installed
  $file_name = 'pdf_datasheet.pdf';

  //set some language-dependent strings
  $pdf->setLanguageArray( $l );

  ////
  // Do all the rest in the modules
  $oscTemplate->buildBlocks();

  // reset pointer to the last page
  $pdf->lastPage();

  // Send the PDF document and quit
