...
*/
  ...
  const MODULE_CONTENT_TEXT_MAIN_TEXT        = 'Hier läuft (mit PHP7.1.2 und MySQL 5.7):<br />
  ...
  Vergessen Sie nicht, alle "Dateinamen" und "einige Inhaltverzeichnisse" sind hartcodiert.<br /><br />
	...
	- Frontend: Deutsche Sprache installiert (99% übersetzt)<br />
	...
	- Backend: Deutsche Sprache installiert (20% übersetzt)<br /><br />
	...
	- Shop entspricht Europa/Deutsches Gesetz<br />
  ...
  - Korrigierte Version 2.3.4 Deutsch utf8<br />
  - Superfish Box 1.2.2<br />
  - Categories Menu XS v1.2<br />
  - Horizontal Categories Menu BS v1.3.1 (von WDW für diese Version angepasst)<br />
  ...
  - Ultimate Seo Urls 5 für Responsive oscommerce<br />
