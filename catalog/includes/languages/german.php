...
define('HEADER_TITLE_CHECKOUT', 'Zur Kasse');
...
define('FORM_REQUIRED_INFORMATION', '<span class="fa fa-asterisk text-danger"></span> Notwendige Eingabe');
...
define('IMAGE_BUTTON_CONFIRM_ORDER', 'Kostenpflichtig bestellen');
...
define( 'IMAGE_SALE', 'Rabatt!' );

// Vat at the price
define('TEXT_INCL_VAT', 'inkl. %s MwSt');
define('TEXT_EXCL_VAT', 'exkl. MwSt');
define('TEXT_VAT', 'MwSt');
define('TEXT_SHIPPING', 'zzgl. <a href="shipping.php">Versand</a>');

// reviews
define('REVIEWS_TEXT_RATED', 'Bewertung %s von <cite title = "%s" itemprop = "author">%s </ cite>');
define('REVIEWS_TEXT_AVERAGE', 'Durchschnittliche Bewertung basierend auf <span itemprop="ratingCount">%s</span> Bewertung(en) %s');
define('REVIEWS_TEXT_TITLE', 'Was unsere Kunden sagen...');

// search placeholder
define('TEXT_SEARCH_PLACEHOLDER','Suchen');

// grid/list
define('TEXT_SORT_BY', 'Sortiert nach ');

// category views
define('TEXT_VIEW', 'Zeige: ');
...
define('TABLE_HEADING_BUY_NOW', 'In den Warenkorb');
define('TABLE_HEADING_LATEST_ADDED', 'Neuste Produkte');

// message for required inputs
define('FORM_REQUIRED_INFORMATION', '<span class="fa fa-asterisk text-danger"></span> Pflichtfeld');
define('FORM_REQUIRED_INPUT', '<span><span class="fa fa-asterisk form-control-feedback text-danger"></span></span>');

// product notifications
define('PRODUCT_SUBSCRIBED', '%s wurde Ihrer Benachrichtigungsliste hinzugefügt');
