    ...
    function execute() {
      ...
      if (tep_not_null(MODULE_HEADER_TAGS_GRID_LIST_VIEW_PAGES)) {
        ...
        if (in_array(basename($PHP_SELF), $pages_array)) {
          ...
          $oscTemplate->addBlock('<script>$(function() {var cc = $.cookie(\'list_grid\');if (cc == \'list\') {$(".wdw_div").addClass(\'wdw_overlay_sale_position_absolute\');$(".wdw_div").removeClass(\'wdw_overlay_sale_position_relative\');$(\'#products .item\').removeClass(\'grid-group-item\').addClass(\'list-group-item\');}else {$(".wdw_div").removeClass(\'wdw_overlay_sale_position_absolute\');$(".wdw_div").addClass(\'wdw_overlay_sale_position_relative\');$(\'#products .item\').removeClass(\'list-group-item\').addClass(\'grid-group-item\');}$(document).ready(function() {$(\'#list\').click(function(event){event.preventDefault();$(".wdw_div").addClass(\'wdw_overlay_sale_position_absolute\');$(".wdw_div").removeClass(\'wdw_overlay_sale_position_relative\');$(\'#products .item\').addClass(\'list-group-item\').removeClass(\'grid-group-item\');$.cookie(\'list_grid\', \'list\');});$(\'#grid\').click(function(event){event.preventDefault();$(".wdw_div").removeClass(\'wdw_overlay_sale_position_absolute\');$(".wdw_div").addClass(\'wdw_overlay_sale_position_relative\');$(\'#products .item\').removeClass(\'list-group-item\').addClass(\'grid-group-item\');$.cookie(\'list_grid\', \'grid\');});});});</script>' . "\n", $this->group);
        }
      }
    }
