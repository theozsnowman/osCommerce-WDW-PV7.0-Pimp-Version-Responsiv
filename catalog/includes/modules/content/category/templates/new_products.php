...
?>
      <div class="col-sm-<?php echo MODULE_CONTENT_CATEGORY_NEW_PRODUCTS_CONTENT_WIDTH_EACH; ?>" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product">
        <div class="thumbnail equal-height">
          <a href="<?php echo tep_href_link('product_info.php', 'products_id=' . $new_products['products_id']); ?>"><?php echo tep_image('images/' . $new_products['products_image'], $new_products['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'itemprop="image"'); ?></a>
          <div class="caption">
