 ...
 */
  ...
  while ( $popular_products = tep_db_fetch_array($popular_products_query) ) {
    ...
    $wdw_vat = ( DISPLAY_TAX_INFO == 'true' ) ? ( DISPLAY_PRICE_WITH_TAX == 'true' ) ? '<br /><span class="wdw_vat_text">'. sprintf(TEXT_INCL_VAT, tep_get_tax_rate($popular_products['products_tax_class_id']).'%') . '</span>' : '<br /><span class="wdw_vat_text">' . TEXT_EXCL_VAT . '</span>' : '';
    ...
    if (tep_not_null($popular_products['specials_new_products_price'])) {
      ...
      $wrapper_slides .= '          <span class="productSpecialPrice" itemprop="price" content="' . $currencies->display_raw($popular_products['products_price'], tep_get_tax_rate($popular_products['products_tax_class_id'])) . '">' . $currencies->display_price($popular_products['specials_new_products_price'], tep_get_tax_rate($popular_products['products_tax_class_id'])) . $PercentRound . $wdw_vat . $wdw_shipping . '</span>';
    } else {
      $wrapper_slides .= '          <span itemprop="price" content="' . $currencies->display_raw($popular_products['products_price'], tep_get_tax_rate($popular_products['products_tax_class_id'])) . '">' . $currencies->display_price($popular_products['products_price'], tep_get_tax_rate($popular_products['products_tax_class_id'])) . $wdw_vat . $wdw_shipping . '</span>';
    }
    $wrapper_slides .= '          </p>';
    $wrapper_slides .= '        </div>';
