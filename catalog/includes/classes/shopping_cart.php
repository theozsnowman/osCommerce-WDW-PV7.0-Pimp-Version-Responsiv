...
// attributes price
    ...
    function get_products() {
      ...
      reset($this->contents);
      while (list($products_id, ) = each($this->contents)) {
        $products_query = tep_db_query("select p.products_id, pd.products_name, p.products_model, p.products_image, p.image_folder, p.image_display, p.products_price, p.products_weight, p.products_tax_class_id from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd where p.products_id = '" . (int)$products_id . "' and pd.products_id = p.products_id and pd.language_id = '" . (int)$languages_id . "'");
        if ($products = tep_db_fetch_array($products_query)) {
          ...
          $products_array[] = array('id' => $products_id,
                                    ...
                                    'image_folder' => $products['image_folder'],
                                    'image_display' => $products['image_display'],                                    
